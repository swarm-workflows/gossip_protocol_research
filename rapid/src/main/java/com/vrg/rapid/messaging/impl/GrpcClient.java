...
public class GrpcClient implements IMessagingClient {
    ...
    public static final int DEFAULT_GRPC_JOIN_TIMEOUT = DEFAULT_GRPC_TIMEOUT_MS * 25;
...
// Check if the latency for this pair is already computed
        ...
        final double latency = Math.min(200, Math.max(meanLatency + gaussian * stdDevLatency, 5));
